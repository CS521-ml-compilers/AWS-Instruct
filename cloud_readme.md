...
1. Log in to the [AWS EC2 dashboard](https://us-west-2.console.aws.amazon.com/console/home?region=us-west-2). On the top right of the page, make sure you are on the `us-east-2` region.
<p align="center">
